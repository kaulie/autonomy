...
- Context Ref 在决策周期开始前被解析成世界（[context-builder.md](context-builder.md)：本进程的容器 + 平台的注册表 —— project、它所属的 organization、那个 organization 登记的 services；引用也可以指向一条 task，那就从那条 task 的 world 接着走）
